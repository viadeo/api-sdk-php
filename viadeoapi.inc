...
class ViadeoIllegalArgumentException extends ViadeoException { }
...
class ViadeoRequest {
    ...
    public function getParams($extras = array()) {
        $params = "";
        if ((count($this->params) > 0) || (count($extras) > 0)) {
...
class ViadeoAPI {
    ...
    // -- Static URIs ---------------------------------------------------------
    public static $oauth_base    = "https://secure.viadeo.com/oauth-provider";
